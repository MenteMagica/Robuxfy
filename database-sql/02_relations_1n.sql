...
ALTER TABLE musics
    ...
    ADD CONSTRAINT fk_musics_artist_id
...
ALTER TABLE playlists
    ADD COLUMN cover_image BIGINT UNSIGNED,
    ADD CONSTRAINT fk_playlists_cover_image
        FOREIGN KEY (cover_image) REFERENCES images(id)
        ON DELETE SET NULL
        ON UPDATE CASCADE;
...
ALTER TABLE artists
    ADD COLUMN banner BIGINT UNSIGNED,
    ADD CONSTRAINT fk_artists_banner
        FOREIGN KEY (banner) REFERENCES images(id)
        ON DELETE SET NULL
        ON UPDATE CASCADE;
